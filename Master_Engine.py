...
# VERSIONE DEL SISTEMA: APEX V8.3 (BULLETPROOF)
# ==========================================
...
def get_price_safe(ticker):
    """Estrazione antiproiettile del prezzo per evitare crash di YFinance"""
    try:
...
def MASTER_START():
    ...
    # 3. RADAR INGRESSI (Basic)
    report_w = ""
    if macro == "ROSSO":
        report_w = "🚨 <b>VETO ROSSO:</b> Mercato volatile. Nessun ingresso autorizzato.\n"
    else:
    ...
    # 4. TRASMISSIONE
    msg = f"📊 <b>APEX V8.3: BULLETPROOF</b> 📊\n"
